...
#SBATCH --output=/sonic_home/igor.viveiros/src/TFB/logs/duet-loss-smoke-%j.out
#SBATCH --error=/sonic_home/igor.viveiros/src/TFB/logs/duet-loss-smoke-%j.err

set -euo pipefail

TFB_ROOT="/sonic_home/igor.viveiros/src/TFB"
PYTHON_BIN="/sonic_home/igor.viveiros/py310/bin/python"
LOG_DIR="/sonic_home/igor.viveiros/src/TFB/logs"
...
echo "Resultado CSV: $TFB_ROOT/artifacts/duet_custom_loss_smoke_results_h3.csv"
