#!/usr/bin/env python3
"""Opt-in launcher for composite_trading_loss_v2.
...
from ts_benchmark.baselines.composite_trading_loss_v2 import (  # noqa: E402
    build_loss,
...
def main() -> None:
    ...
    os.environ["TFB_CUSTOM_LOSS_API"] = "composite_trading_v2"
