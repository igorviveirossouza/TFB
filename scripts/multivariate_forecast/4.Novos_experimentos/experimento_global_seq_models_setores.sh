  ...
  for MODEL_KEY in "${MODELS[@]}"; do
    ...
    case "$MODEL_KEY" in
      ...
      "TIOMS_CROSS_OHLC_MSE")
        ...
        MODEL_HYPER_PARAMS="{\"loss\": \"MSE\", \"embedding_type\": \"nonlinear\", \"embedding_hidden_dim\": 16, \"lag_size\": 7, \"spectral_num_freqs\": 18, \"causal_att\": \"causal\", \"channel_agg_type\": \"none\", \"seq_len\": ${SEQ_LEN}, \"pred_len\": ${PRED_LEN}, \"horizon\": ${PRED_LEN}, \"label_len\": ${LABEL_LEN}, \"batch_size\": 8, \"dropout\": 0.1, \"eps\": 1e-5, \"d_model\": 32, \"n_heads\": 4, \"ff_dim\": 128, \"channel_n_heads\": 4, \"patience\": 8, \"num_epochs\": 60, \"temporal_pool_type\": \"last\"}"
        DATASET_ARG=(--data-set-name "user_forecast_ohlcv")
        EVAL_BACKEND_ARG=(--eval-backend sequential)
        ;;
      "TIOMS_ENC_DEC_OHLC_MSE_PAR")
