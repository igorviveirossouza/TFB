...
#SBATCH --error=/sonic_home/igor.viveiros/src/TFB/logs/b3-loss-clean-b-%A_%a.err
...
# Experimento B — diagnóstico.
# Treina MSE ponto-a-ponto em H x N; o acúmulo ocorre somente no backtest.
# Grade default: 2 datasets x 4 modelos x 1 loss x 3 lookbacks x 5 horizontes = 120 jobs.

MODELS_CSV="${MODELS:-duet,timesnet,fedformer,nonstationary}"
LOSSES_CSV="${LOSSES:-mse_step_accum}"
...
printf 'EXPERIMENTO=B TASK_ID=%s/%s\n' "$TASK_ID" "$TOTAL"
